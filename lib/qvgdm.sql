...
--
-- Serveur: localhost
-- Généré le : Lun 04 Mars 2013 à 14:07
...
INSERT INTO `joueur` (`id_joueur`, `nom`) VALUES
(1, 'Boris1'),
(2, 'Boris2'),
(3, 'Boris3'),
(4, 'Boris4'),
...
INSERT INTO `joueur_reponse` (`id_joueur_reponse`, `id_joueur`, `id_question`, `id_reponse`) VALUES
(1, 5, 34, 2);
...
INSERT INTO `joueur_score` (`id_joueur`, `date`, `score_final`) VALUES
(1, '2013-03-08 00:00:00', 3000),
(2, '2013-03-09 00:00:00', 6000),
(3, '2013-03-20 00:00:00', 6000),
(4, '2013-03-06 00:00:00', 1500),
(5, '2013-03-05 00:00:00', 48000);
...
(122, 'Quel est le seul mammifère qui pond des œufs ?', 1),
(123, 'La vache a fait la une des journaux en 1996 car elle était devenue', 1),
(124, 'Quelle scientifique française du début du XX° siècle a obtenu deux prix Nobel ?', 1),
(125, 'Quel navire a sombré après avoir heurté un iceberg  ?', 1),
(126, 'Lequel n’est pas né en Russie ?', 1),
(127, 'Lequel de ces athlètes  n’est  pas un des champions de natation des JO 2012  ?', 1),
(128, 'Qui a inventé le vaccin contre la rage ?', 1),
(129, 'Quelle est la plus longue ligne de chemin de fer du monde ?', 1),
(130, 'Qu’est-ce qu’un silure ?', 1),
(131, 'Qui est l’ auteur du roman : l’étranger ?', 1),
(132, 'Que jouait Molière lorsqu’il fut pris d’un malaise fatal  ?', 1),
(133, 'Qui vit sur l’astéroïde B612 ?', 1),
(134, 'Dans Le Livre de la jungle, quel est le nom de l’ours ?', 1),
(135, 'Quel est le poids d’un porc à la fin de sa vie ?', 1),
(136, 'Quelle plante fut introduite en France par Jean Nicot au 16°s ?', 1),
(137, 'A l’origine, le jean était un vêtement de :', 1),
(138, 'Dans un métier à tisser, quel objet emmène le fil ?', 1),
(139, 'Par quel moyen de transport les soldats ont-ils rejoint la bataille de la Marne en 1914 ?', 1),
...
(143, 'De quel handicap souffrait l’inventeur Louis Braille ?', 1),
(144, 'En quelle année a été découvert le rayon laser ?', 1),
(145, 'Complétez la devise des JO : « Plus vite, plus haut, plus…', 1),
(146, 'Dans quel sport porte-t-on une ceinture de plomb ?', 1),
(147, 'Qui transmet la maladie du sommeil ?', 1),
(148, 'Comment appelait-on celui qui attaquait les bateaux pour le compte de son roi ?', 1),
(149, 'Quand on voit mal de loin, on est', 1),
(150, 'Sur la langue, se trouvent : ', 1),
(151, 'Qu’a perdu un amnésique ?', 1),
(152, 'Quel acide, capital pour la connaissance de l’information génétique, a été découvert en 1953 ?', 1),
(153, 'En quelle année a eu lieu la Révolution Française ?', 1),
(154, ' Mazarin était un :', 1),
(155, 'Qui a-t-on appelé les poilus ?', 1),
(156, 'Le Roi Richard Cœur de Lion était :', 1),
(157, ' A quelle période a vécu François 1er ?', 1),
(158, ' La nuit du massacre de la Saint Barthélemy, on a tué :', 1),
(159, 'De quelle région est originaire Jeanne d''Arc ?', 1),
(160, 'Quelle dynastie ne régna jamais en France ?', 1),
(161, ' Comment appelait-on l''écriture des égyptiens sous les pharaons ?', 1),
(162, 'Lequel de ces hommes n''est pas un révolutionnaire ?', 1),
(163, ' Quelle course n''est pas une course automobile ?', 1),
(164, ' Lequel de ces petits engins n''est pas utilisé en gymnastique rythmique ?', 1),
(165, 'Quelle arme n''est pas utilisée en escrime ?', 1),
(166, 'Au tennis, quel tournoi ne fait pas partie du grand chelem ?', 1),
(167, 'Quel nom rime avec Paul-Loup Sulitzer dans "Foule sentimentale" de Souchon ? ', 1),
(168, ' Dans quelle ville se déroule chaque année le Festival interceltique ? ', 1),
(169, 'Quel est l''impératif du verbe peindre à la 2e personne du pluriel ? ', 1),
(170, 'Quel nom porte le bateau dont Théodore Géricault peint le radeau ? ', 1),
(171, 'Qui cause des problèmes à Michel Blanc dans "Grosse Fatigue" ? ', 1),
(172, 'Jusqu''à combien Ricky Martin compte-t-il dans sa chanson "Maria" ? ', 1),
...
(178, 'Quel film a remporté le César du Meilleur film en 2013 ?', 1),
(179, 'Quel couple de petits personnages rouge et bleu s''anime en 1974 ? ', 1),
(180, 'Dans le film Paris de Klapisch qui est la soeur de Romain Duris?', 1),
...
(483, 'Suède', 121, 0),
(484, 'Grèce', 121, 1),
(485, 'Le hérisson', 122, 0),
(486, 'L’ornithorynque', 122, 1),
(487, 'Le pingouin', 122, 0),
(488, 'Le kangourou', 122, 0),
(489, 'Acrobate', 123, 0),
(490, 'Gracieuse', 123, 0),
(491, 'Folle', 123, 1),
(492, 'Sans couenne', 123, 0),
(493, 'Bernadette Soubirous', 124, 0),
(494, 'Thérèse Desqueyroux', 124, 0),
(495, 'Adrienne Bolland', 124, 0),
(496, 'Marie Curie', 124, 1),
(497, 'La santa Maria', 125, 0),
(498, 'Le Titanic', 125, 1),
(499, 'Le Costa Concordia', 125, 0),
(500, 'Le Nautilus', 125, 0),
(501, 'Gérard Depardieu', 126, 1),
(502, 'Sophie Rostopchine', 126, 0),
(503, 'Lénine', 126, 0),
(504, 'Anna Kournikova', 126, 0),
(505, 'Yannick Agnel', 127, 0),
(506, 'Camille Muffat', 127, 0),
(507, 'Tony Estanguet', 127, 1),
(508, 'Clément Lefert', 127, 0),
(509, 'Ghislaine Arabian', 128, 0),
(510, 'Louis Pasteur', 128, 1),
(511, 'Jules Renard', 128, 0),
(512, 'Robert Pattinson', 128, 0),
(513, 'Le Trouville-Limoges', 129, 0),
(514, 'L’Orient-Express', 129, 0),
(515, 'Le transsibérien', 129, 1),
(516, 'Le California Zephyr', 129, 0),
(517, 'Un arbre', 130, 0),
(518, 'Un outils agricole', 130, 0),
(519, 'Un copeau de bois', 130, 0),
(520, 'Un poisson', 130, 1),
(521, 'Victor Hugo', 131, 0),
(522, 'Georges Brassens', 131, 0),
(523, 'Albert Camus', 131, 1),
(524, 'Omar Sy', 131, 0),
(525, 'Intouchable', 132, 0),
(526, 'Docteur House', 132, 0),
(527, 'Le misanthrope', 132, 0),
(528, 'Le malade imaginaire', 132, 1),
...
(541, 'L’abricot', 136, 0),
(542, 'Le tabac', 136, 1),
(543, 'L’aubergine', 136, 0),
(544, 'Le narcisse', 136, 0),
(545, 'Travail', 137, 1),
(546, 'Sport', 137, 0),
(547, 'Loisir', 137, 0),
(548, 'Bagnards', 137, 0),
(549, 'La navette', 138, 1),
(550, 'L’aiguille', 138, 0),
(551, 'Le chas', 138, 0),
(552, 'La fourchette', 138, 0),
(553, 'Des chevaux', 139, 0),
(554, 'Des parachutes', 139, 0),
(555, 'Des taxis', 139, 1),
(556, 'Des charrettes', 139, 0),
(557, 'Bleu', 140, 1),
(558, 'Jaune', 140, 0),
(559, 'Vert', 140, 0),
(560, 'Violet', 140, 0),
...
(579, 'fort', 145, 1),
(580, 'riche', 145, 0),
(581, 'Le tir à la carabine', 146, 0),
(582, 'Le pilate', 146, 0),
(583, 'Le sumo', 146, 0),
(584, 'La plongée', 146, 1),
(585, 'Nounours', 147, 0),
(586, 'La mouche tsé-tsé', 147, 1),
(587, 'Le moustique chikungunya', 147, 0),
(588, 'Morphée', 147, 0),
(589, 'Un pirate', 148, 0),
(590, 'Un corsaire', 148, 1),
(591, 'Un martin pilleur', 148, 0),
(592, 'Un Bern', 148, 0),
(593, 'Myope', 149, 1),
(594, 'Presbyte', 149, 0),
(595, 'Hypermétrope', 149, 0),
(596, 'Stéréotype', 149, 0),
...
(604, 'Sa foi', 151, 0),
(605, 'acide folique', 152, 0),
(606, 'acide formique', 152, 0),
(607, 'acide hyaluronique', 152, 0),
(608, 'acide désoxyribonucléique', 152, 1),
(609, '1750', 153, 0),
(610, '1789', 153, 1),
(611, '1804', 153, 0),
(612, '1945', 153, 0),
...
(615, 'Cardinal', 154, 1),
(616, 'Prince', 154, 0),
(617, 'les naturistes', 155, 0),
(618, 'les insurgés', 155, 0),
(619, 'les révolutionnaires', 155, 0),
(620, 'les soldats de 1914 - 1918', 155, 1),
(621, ' Allemand', 156, 0),
(622, ' Italien', 156, 0),
(623, ' Français', 156, 0),
(624, ' Anglais', 156, 1),
(625, ' Le Moyen Âge', 157, 0),
(626, ' La Renaissance', 157, 1),
(627, ' L''Empire', 157, 0),
(628, 'Le 20° siècle', 157, 0),
(629, 'Les Maurice', 158, 0),
(630, 'Les protestants', 158, 1),
(631, 'les  Barthélemy', 158, 0),
(632, 'Les catholiques', 158, 0),
(633, 'La Beauce', 159, 0),
(634, 'La Lorraine', 159, 1),
(635, 'La Picardie', 159, 0),
(636, 'L''Alsace', 159, 0),
(637, ' Carolingiens', 160, 0),
(638, ' Capétiens', 160, 0),
(639, 'Tudors', 160, 1),
(640, ' Mérovingiens', 160, 0),
(641, ' cyrillique', 161, 0),
(642, 'romaine', 161, 0),
(643, 'hiéroglyphes', 161, 1),
(644, 'hébraïque', 161, 0),
(645, 'Danton', 162, 0),
(646, 'Ravaillac', 162, 1),
(647, 'Robespierre', 162, 0),
(648, 'Marat', 162, 0),
...
(656, 'rubans', 164, 0),
(657, 'Le sabre', 165, 0),
(658, 'Le fleuret', 165, 0),
(659, 'la dague', 165, 1),
(660, ' l''épée', 165, 0),
(661, 'BERCY', 166, 1),
(662, 'WIMBLEDON', 166, 0),
(663, 'US OPEN', 166, 0),
(664, ' OPEN D''AUSTRALIE', 166, 0),
(665, 'Claude Miller', 167, 0),
(666, 'Michel Drucker', 167, 0),
(667, 'Claudia Schiffer ', 167, 1),
(668, 'Arnaud Tsamère', 167, 0),
(669, 'Brest', 168, 0),
(670, 'Londres', 168, 0),
(671, 'Moscou', 168, 0),
(672, 'Lorient ', 168, 1),
...
(674, 'Peignez ', 169, 1),
(675, 'Peindez', 169, 0),
(676, 'Peinturlurez', 169, 0),
(677, 'La rascasse', 170, 0),
(678, 'La Divine', 170, 0),
(679, 'La Méduse ', 170, 1),
(680, 'L''insubmersible', 170, 0),
(681, 'Sa fille', 171, 0),
(682, 'Son sosie ', 171, 1),
(683, 'Miou-Miou', 171, 0),
(684, 'Thierry Lhermitte', 171, 0),
(685, '3', 172, 1),
(686, '5', 172, 0),
(687, '6', 172, 0),
(688, '26', 172, 0),
...
(708, 'L''amour', 177, 0),
(709, 'De Rouille et d''os', 178, 0),
(710, 'Le Prenom', 178, 0),
(711, 'Amour ', 178, 1),
(712, 'Un prophète', 178, 0),
(713, 'Daniel et Valérie', 179, 0),
(714, 'Chapi Chapo ', 179, 1),
(715, 'Nicolas et Pimprenelle', 179, 0),
(716, 'Daniel Cohn-Bendit et Valéry Giscard d’Estaing', 179, 0),
(717, 'Mélanie Laurent', 180, 0),
(718, 'Juliette Binoche', 180, 1),
(719, 'Ludivine Sagnier', 180, 0),
(720, 'Audrey Tautou', 180, 0),
